    ...
    return(
        ...
        <div className="container">
            <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <li>  <NavLink to="/news" className="nav-link px-2 text-secondary" >News</NavLink></li>
                <li>  <NavLink to="/product-detail" className="nav-link px-2 text-secondary" >Product</NavLink></li>      
